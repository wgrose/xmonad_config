...
--
myLayout = resizable ||| tiled ||| Mirror tiled ||| Full
  where
...
main = do
     xmproc <- spawnPipe "/home/wgrose/.xmonad/statusBarStartup.sh"
     xmproc <- spawnPipe "gnome-screensaver"
